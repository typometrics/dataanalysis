...
position_data, validation_info = compute_sizes_table({'fr': all_avgs['fr']}, table_type='standard', all_langs_position2num={'fr': d_num['fr']})
...
mapped = filter_and_map_ordering_stats(lang_order, 'strict')
print("mapped right 4 2:", mapped.get(('right', 4, 2)))

table = create_verb_centered_table(position_data, config, ordering_stats=mapped, validation_info=validation_info)
