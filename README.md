...
### Documentation (`docs/`)
- `HELIX_TABLE_METHODOLOGY.md` - (Formerly GUIDE + GEOMETRIC_MEAN_INFO)
- `HELIX_TABLE_USER_GUIDE.md` - User-facing guide
- `VERB_CENTERED_ANALYSIS_GUIDE.md` - Implementation details
- `SENTENCE_DISORDER_GUIDE.md` - Disorder analysis guide
- ...and various implementation plans/reports.
